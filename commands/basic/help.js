...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.isCommand && interaction.isCommand()) {
            ...
            const BOT_ICON = "https://media.discordapp.net/attachments/1395928113321611355/1396762158108381285/pfp.gif?ex=687f43a1&is=687df221&hm=3b8a1af1d56ddd3bf2a636eb74d9377d60856b1e3987d1cc8e72d38c7497f14c&=&width=171&height=171";
            const EMBED_COLOR = "#5865F2"; 
            const FOOTER_TEXT = "All In One | The Discord Operating System • Created by QSMIDI";
            ...
            const createEmbed = () => {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setAuthor({
                        ...
                        iconURL: BOT_ICON,
                        url: "https://discord.gg/kmFz64z2cY"
                    })
                    .setImage(helpBanner)
